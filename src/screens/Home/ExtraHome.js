...
import styles from '../../styles/HomeScreen/ExtraHome';

const { width, height } = Dimensions.get('window');

const videoSource = require('../../../assets/RealAfter.mp4');
  ...
  return (
    ...
    <View style={styles.tabBar}>
      <TouchableOpacity style={styles.tabItem} activeOpacity={0.7}>
        ...
        <Text style={[styles.tabText, { color: '#3B82F6' }]}>홈</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.tabItem} activeOpacity={0.7}>
        <Ionicons name="layers-outline" size={24} color="#555" />
        <Text style={styles.tabText}>쿠폰샵</Text>
      </TouchableOpacity>
